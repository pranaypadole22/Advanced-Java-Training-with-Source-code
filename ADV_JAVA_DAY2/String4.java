...
//WAF which accept one string and convert that string into sentence case(Title case).
//I/P:-this is test
//O/P:- This IS Test
public class String4 {
    public static void title(String s1){
        String []words=s1.split(" ");

        for (String word:words) {
            char st=word.charAt(0);
          char ch= Character.toUpperCase(st);
          String newS=ch+word.substring(1);
